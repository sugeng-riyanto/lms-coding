...
export const DASH = {
  ...
  bankFilterPlaceholder: { id: "Cari soal…", en: "Search questions…" },
  bankFilterType: { id: "Semua tipe", en: "All types" },
  bankFilterDifficulty: { id: "Semua tingkat", en: "All difficulty" },
  bankFilterCourse: { id: "Semua kursus", en: "All courses" },
  bankFilterStatusAll: { id: "Semua status", en: "All status" },
  bankFilterUsed: { id: "Terpakai", en: "Used" },
  bankFilterIdle: { id: "Menganggur", en: "Idle" },
  bankResults: { id: "{n} soal ditampilkan", en: "{n} questions shown" },
  bankNoResults: { id: "Tidak ada soal yang cocok filter.", en: "No questions match the current filters." },
  bankPrev: { id: "Sebelumnya", en: "Previous" },
  bankNext: { id: "Berikutnya", en: "Next" },
  bankPageOf: { id: "{page} dari {total}", en: "{page} of {total}" },
  bankFootnote: {
